# Terms and Conditions — Global Hackfest 2026

Effective: 2026-01-23. Last updated: 2026-01-23.
...
Conflux Foundation runs the hackathon ("we", "us", "our").

## 3. Eligibility

You must be 18+ (or have parent/guardian consent), able to enter a binding agreement, and not in a sanctioned country. You must follow applicable law.

Solo or teams of up to 5. All members must be eligible. Team roster is fixed after the submission deadline.

Not eligible: Conflux Foundation employees and their immediate family; judges and their immediate family; anyone organizing or administering the hackathon. Past winners can participate but cannot win again in the same hackathon.
...
5 Main Awards ($1,500 each), 5 Category Awards ($500 each): Best USDT0 integration, Best AxCNH integration, Best AI + Conflux, Best DeFi project, Best Developer Tool. Total $10,000 USD.

Paid in CFX on eSpace. Winners must give wallet details and tax info if we ask. To receive the prize you must send the winner pitch/demo video (see submission guide). Taxes are your responsibility.
...
2. Open a submission pull request to the hackathon repository with their project materials using the provided template
3. Create a pull request to [electric-capital/open-dev-data](https://github.com/electric-capital/open-dev-data) to add their project to the Conflux ecosystem
4. Post a social media announcement on Twitter/X tagging @ConfluxDevs and @ConfluxNetwork
5. Ensure the submission pull request includes links to required external materials (Electric Capital PR, social post, live demo, etc.)
6. Include all required materials: code, documentation (including go-to-market plan), demo video, and participant intro video
...
- README and project documentation following the provided template, including a **go-to-market plan**
- Demo video (3-5 minutes maximum)
- Participant intro video (30–60 seconds; used at a conference in Hong Kong)
- Live demo URL (if applicable)
- Project presentation slides (optional but recommended)

Submissions missing any required materials (excluding explicitly optional items) may be considered incomplete and ineligible for prizes at the organizers' discretion.
...
- **Expert Evaluation**: Technical assessment by qualified judges (no live presentations)
- **Final Selection**: Top 10 projects selected based on comprehensive scoring; winner showcase videos used for the official winners video
...
- Hackathon platforms and tools are provided "as is" without warranties
...
These Terms constitute the entire agreement between participants and Conflux Foundation regarding hackathon participation.
...
**By participating in Global Hackfest 2026, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.**